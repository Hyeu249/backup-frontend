...
//Vehicle Icons
export const CarIcon = IoMdCar; // Flame icon

//person
export const PeopleIcon = IoIosPeople; // Flame icon
export const PersonOutlineIcon = MdPersonOutline; // Flame icon
export const LogOutIcon = IoIosLogOut; // Flame icon
export const AttachIcon = IoIosAttach; // Flame icon
