...
import useTyreServiceRequest from './hook/useTyreServiceRequest';
import CreateModal from './CreateModal/CreateModal';

export default function TyreServiceRequest() {
  const {
    createOpen,
    setCreateOpen,
    tyreServiceRequests,
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.tyreServiceRequest" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="sidebar.addTyreServiceRequest" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Tyre Service Request">
          {tyreServiceRequests?.length === 0 ? (
            <HelperText text="No Tyre Service Requests" />
          ) : (
            <div className="isoTable">
              ...
              >
                <TableWrapper
                  ...
                  dataSource={tyreServiceRequests}
                  columns={columns}
                  pagination={false}
                  className="ListTable"
                />
