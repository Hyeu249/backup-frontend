...
import useManageEquipment from './hook/useManageEquipment';
...
export default function ManageEquipment() {
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.manageEquipment" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="sidebar.addEquipment" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Equipment">
          {equipments?.length === 0 ? (
            <HelperText text="No Equipments" />
          ) : (
