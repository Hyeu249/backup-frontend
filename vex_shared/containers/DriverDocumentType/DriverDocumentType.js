...
import useDriverDocumentType from './hook/useDriverDocumentType';
...
export default function DriverDocumentType() {
  const {
    createOpen,
    setCreateOpen,
    editOpen,
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.driverDocumentType" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="text.addDriverDocumentType" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Driver Document">
          {driverDocumentTypes.length === 0 ? (
            ...
            <div className="isoTable">
              ...
              >
                <TableWrapper
                  ...
                  dataSource={driverDocumentTypes}
                  columns={columns}
                  pagination={false}
                  className="ListTable"
                />
