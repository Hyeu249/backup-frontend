...
import useManageRole from './hook/useManageRole';
import CreateModal from './CreateModal/CreateModal';

export default function ManageRole() {
  const { createOpen, setCreateOpen, roles, rowSelection, columns, callBack } =
    useManageRole();
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.manageRole" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="sidebar.addRole" />
            </span>
          </Button>
        </div>
