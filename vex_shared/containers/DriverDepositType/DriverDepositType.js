...
import useDriverDepositType from './hook/useDriverDepositType';
// import CardWrapper, { Box } from './DriverDepositType.styles';
...
export default function DriverDepositType() {
  const {
    createOpen,
    setCreateOpen,
    editOpen,
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.driverDepositType" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="text.addDriverDepositType" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Driver Document">
          {driverDepositTypes.length === 0 ? (
            <HelperText text="No Driver Documents" />
          ) : (
