...
import useEquipmentServiceRequest from './hook/useEquipmentServiceRequest';
...
export default function EquipmentServiceRequest() {
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.equipmentServiceRequest" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="sidebar.addEquipmentServiceRequest" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Equipment Service Request">
          {equipmentServiceRequests?.length === 0 ? (
            <HelperText text="No Equipment Service Requests" />
          ) : (
            <div className="isoTable">
              ...
              >
                <TableWrapper
                  ...
                  dataSource={equipmentServiceRequests}
                  columns={columns}
                  pagination={false}
                  className="ListTable"
                />
