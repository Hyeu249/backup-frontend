...
import useManageSupplier from './hook/useManageSupplier';
...
export default function ManageSupplier() {
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.manageSupplier" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="sidebar.addSupplier" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Supplier">
          {suppliers?.length === 0 ? (
            <HelperText text="No Suppliers" />
          ) : (
