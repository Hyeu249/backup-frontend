...
import useSupplierQuote from './hook/useSupplierQuote';
...
export default function SupplierQuote() {
  ...
  return (
    <LayoutWrapper>
      <PageHeader>
        <IntlMessages id="sidebar.supplierQuote" />
      </PageHeader>
      <Box>
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ lineHeight: '200' }}>
              <IntlMessages id="sidebar.addSupplierQuote" />
            </span>
          </Button>
        </div>

        <CardWrapper title="Supplier Quote">
          {supplierQuotes?.length === 0 ? (
            <HelperText text="No Supplier Quotes" />
          ) : (
